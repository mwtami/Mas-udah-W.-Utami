...
<head>
  ...
  <title>E-Bpjs | Detail Quota Admin</title>
      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url("Quota_admin/detail/".md5(sha1($detail->id_ambil_quota))); ?>" enctype="multipart/form-data">
                    <div class="box-body">
                          <div class="col-md-6">
                            <fieldset disabled>
