...
<head>
  ...
  <title>E-Bpjs | Quota Admin</title>
          ...
          <div class="box box-default">
            <div class="box-header">
              ...
              <div class="box-title col-md-12">
                <div class="row">
                  <form action="<?php echo site_url('Quota_admin')?>" class="form-horizontal" method="post">
        				  <div class="col-md-3">
              ...
              <table class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  if(count($tanggal) == 2)
                  {
                  	...
                  	$tgl_jadi = $tgl_p[2].'-'.nama_bulan($tgl_p[1]).'-'.$tgl_p[0].' '.$tanggal[1];
                  	echo $tgl_jadi;
                  }
                  ?>
                  </td>
                  ...
                  <td align="center">
                    <button type="button" name="btn_ubah" class="btn btn-sm btn-primary"  onClick="location.href=('<?php echo $baris->nik_pegawai ?>','<?php echo site_url("Quota_admin/detail/".md5(sha1($baris->id_ambil_quota)));?>');" data-toggle="tooltip" data-placement="top" title="Detail Data"><span class="glyphicon glyphicon-eye-open"></span></button>
                    <button type="button" name="btn_hapus" class="btn btn-sm btn-primary"  onclick="return hapus_data('<?php echo $baris->nik_pegawai ?>','<?php echo site_url("Quota_admin/hapus/".$baris->id_ambil_quota);?>');" data-toggle="tooltip" data-placement="top" title="Hapus Data"><span class="glyphicon glyphicon-trash"></span></button>
                    ...
                    <button type="button" class="btn btn-sm btn-primary" onClick="location.href='<?php echo site_url("Quota_admin/download/".$baris->id_ambil_quota);?>'" data-toggle="tooltip" data-placement="top" title="Unduh Slip Bukti"><span class="fa fa-file-image-o"></span></button>
                  </td>
                </tr>
                <?php
                $no++;
            ...
            <!-- /.box-body -->
              ...
              <?php
    					...
    					{
    					?>
              <a href="<?php echo site_url("Quota_admin"); ?>">
