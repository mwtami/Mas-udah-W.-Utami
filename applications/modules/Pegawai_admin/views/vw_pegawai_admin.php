...
<head>
  ...
  <title>E-Bpjs | Pegawai Admin</title>
...
<!-- end header -->
          ...
          <div class="box box-default">
            <div class="box-header">
              ...
              <div class="box-title col-md-12">
                <div class="row">
                  <form action="<?php echo site_url('Pegawai_admin')?>" class="form-horizontal" method="post">
        				  <div class="col-md-2">
          					<div class="form-group" style="margin-bottom: 3px;">
          					  <select class="form-control selectpicker" name="cari_jabatan" id="cari_jabatan" onChange="this.form.submit()">
                  ...
                  <div class="col-md-2">
                    <button type="button" class="btn btn-primary"  onclick="return update_quota('<?php echo site_url("Pegawai_admin/update_quota");?>');"><span class="fa fa-edit"></span> Update Quota</button>
                  </div>
				        </form>
              </div>
              </div>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <td align="center"><img src="<?php echo base_url(); ?>assets/img/<?php echo $baris->foto; ?>" width="60" height="60" class="img-circle" alt="" /></td>
                  <td><?php echo $baris->nik; ?></td>
                  <td><?php echo $baris->nama; ?></td>
                  <td><?php echo $baris->nama_jabatan; ?></td>
                  <td><?php if($baris->jenis_kelamin == 'L'){echo "Laki-laki";}else{echo "Perempuan";} ?></td>
                  <td>Rp. <?php echo number_format($baris->quota_pegawai,0,',','.'); ?></td>
                  <td align="center">
                    <button type="button" name="btn_ubah" class="btn btn-sm btn-primary"  onClick="location.href=('<?php echo $baris->nama ?>','<?php echo site_url("Pegawai_admin/detail/".md5(sha1($baris->nik)));?>');" data-toggle="tooltip" data-placement="top" title="Detail Data"><span class="glyphicon glyphicon-eye-open"></span></button>
                    <button type="button" name="btn_hapus" class="btn btn-sm btn-primary"  onclick="return hapus_data('<?php echo $baris->nama ?>','<?php echo site_url("Pegawai_admin/hapus/".$baris->nik);?>');" data-toggle="tooltip" data-placement="top" title="Hapus Data"><span class="glyphicon glyphicon-trash"></span></button>
                  </td>
                </tr>
                <?php
                $no++;
            ...
            <!-- /.box-body -->
              ...
              <?php
    					...
    					{
    					?>
              <a href="<?php echo site_url("Pegawai_admin"); ?>">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="">IFIK 41 02</a>.</strong> Kelompok 6.
  </footer>
...
<script>
  ...
  //modal hapus
  function update_quota(url)
	{
		pesan = confirm ("Yahkin Ingin Update Quota ?");
		if(pesan == true)
		{
			location.href=url;
			return true;
