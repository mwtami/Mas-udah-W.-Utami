            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <td align="center">
                  <button type="button" name="btn_ubah" class="btn btn-sm btn-primary"  onClick="location.href=('<?php echo $baris->nik_pegawai ?>','<?php echo site_url("Profil/detail/".md5(sha1($baris->id_login_user)));?>');" data-toggle="tooltip" data-placement="top" title="Detail Data"><span class="glyphicon glyphicon-eye-open"></span></button>
                  </td>
                </tr>
                <?php
                $no++;
