...
<head>
  ...
  <title>E-Bpjs | Entry Jabatan Admin</title>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Entry Data Jabatan</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url("Jabatan_admin/tambah"); ?>">
                    <div class="box-body">
                        <div class="col-md-6">
                            <div class="form-group <?php if(form_error('level_jabatan')){echo "has-error";} ?>">
                                <label for="level_jabatan">Level Jabatan</label>
                                <input type="text" name="level_jabatan" class="form-control" id="level_jabatan" value="<?php echo set_value('level_jabatan') ?>" onKeyPress="return hanyaAngka(event, false)" placeholder="Level Jabatan" maxlength="3">
                                <?php if(form_error('level_jabatan')){echo '<span class="control-label" for="level_jabatan">'.form_error('level_jabatan').'</span>';} ?>
                            </div>
                            ...
                            <div class="form-group <?php if(form_error('quota')){echo "has-error";} ?>">
                                ...
                                <input type="text" name="quota" class="form-control" id="quota" value="<?php echo set_value('quota') ?>" onKeyPress="return hanyaAngka(event, false)" placeholder="Quota">
                    ...
                    <div class="box-footer">
                        ...
                        <button type="button" class="btn btn-default" onClick="location.href='<?php echo site_url("Jabatan_admin");?>'"><span class="fa fa-times"></span> Batal</button>
                    </div>
                </form>
            </div>
            <!-- /.box -->
