...
<!-- end header -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> Quota</li>
        ...
        <div class="col-xs-12">
          <div class="box box-default">
            <div class="box-header">
              <h3 class="box-title">Data Quota Pegawai</h3>
              <hr style="margin-top:10px; margin-bottom:0px;">
              <h5>Jumlah Pengambilan : <b><?php echo $jumlah; ?></b></h5>
              <h5>Sisa Quota : <b>Rp. <?php echo number_format($quota->quota_pegawai,0,',','.');  ?></b></h5>
              <h5>Total Quota Diambil : <b>Rp. <?php echo number_format($jumlah_quota->jml_quota,0,',','.');  ?></b></h5>
              <hr style="margin-top:10px;">
              <div class="box-title col-md-12">
                <div class="row">
                  <form action="<?php echo site_url('Quota')?>" class="form-horizontal" method="post">
        				  <div class="col-md-3">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <td align="center">
                    <button type="button" name="btn_ubah" class="btn btn-sm btn-primary"  onClick="location.href=('<?php echo $baris->nik_pegawai ?>','<?php echo site_url("Quota/detail/".md5(sha1($baris->id_ambil_quota)));?>');" data-toggle="tooltip" data-placement="top" title="Detail Data"><span class="glyphicon glyphicon-eye-open"></span></button>
                    ...
                    <button type="button" class="btn btn-sm btn-primary" onClick="location.href='<?php echo site_url("Quota/download/".$baris->id_ambil_quota);?>'" data-toggle="tooltip" data-placement="top" title="Unduh Slip Bukti"><span class="fa fa-file-image-o"></span></button>
                  </td>
                </tr>
                <?php
                $no++;
            ...
            <!-- /.box-body -->
              ...
              <?php
    					...
    					{
    					?>
              <a href="<?php echo site_url("Quota"); ?>">
