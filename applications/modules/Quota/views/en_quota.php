...
<head>
  ...
  <title>E-Bpjs | Ambil Quota</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> Quota Pegawai</li>
      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url("Quota/ambil"); ?>" enctype="multipart/form-data">
                    <div class="box-body">
                          <div class="col-md-6">
                            ...
                            <div class="form-group <?php if(form_error('ambil_quota')){echo "has-error";} ?>">
                              <label>Ambil Quota</label></br>
                                ...
                                <div class="row">
                                <div class="col-xs-6">
                                  <input id='ex2' name='ambil_quota' type='text' value='<?php echo set_value("ambil_quota") ?>' class='form-control' onkeyup='this.value = minmax(this.value, 0, <?php echo $ambil->quota_pegawai ?>)' maxlength="9">
                                </div>
                                <div class="col-xs-6">
                    ...
                    <div class="box-footer">
                        ...
                        <button type="button" class="btn btn-default" onClick="location.href='<?php echo site_url("Quota");?>'"><span class="fa fa-times"></span> Batal</button>
                    </div>
                </form>
            </div>
            <!-- /.box -->
