...
<head>
  ...
  <title>E-Bpjs | Entry User Admin</title>
      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url("User_admin/tambah"); ?>" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="col-md-6">
                              ...
                              <select name="nik_pegawai" id="nik_pegawai" class="form-control chosen-select">
                                <?php
                                 if(isset($_POST['nik_pegawai'])){
                                     $ambil = $this->m_user_admin->getJabatan($_POST['level_jabatan']);
                    ...
                    <div class="box-footer">
                        ...
                        <button type="button" class="btn btn-default" onClick="location.href='<?php echo site_url("User_admin");?>'"><span class="fa fa-times"></span> Batal</button>
                    </div>
                </form>
            </div>
            <!-- /.box -->
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $.ajax({
           type : "POST",
           url  : "<?php echo site_url('User_admin/ambil_jabatan'); ?>",
